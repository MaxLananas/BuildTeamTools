...
public class CropTypeMenu extends AbstractMenu {
    ...
    protected void setPreviewItems() {
        ...
        ItemStack potatoItem = Item.create(Objects.requireNonNull(XMaterial.POTATO.get()), "§bPotato", ListUtil.createList("",
                "§8Left-click to select", "§8Right-click for more information"));
        ItemStack wheatItem = Item.create(Objects.requireNonNull(XMaterial.WHEAT.get()), "§bWheat", ListUtil.createList("",
                "§8Left-click to select", "§8Right-click for more information"));
        ItemStack cornItem = Item.create(Objects.requireNonNull(XMaterial.PUMPKIN_SEEDS.get()), "§bCorn", ListUtil.createList(
                "", "§8Left-click to select", "§8Right-click for more information"));
        ItemStack vineyardItem = Item.create(Objects.requireNonNull(XMaterial.VINE.get()), "§bVineyard", ListUtil.createList(""
                , "§8Left-click to select", "§8Right-click for more information"));
        ItemStack pearItem = Item.create(Objects.requireNonNull(XMaterial.SLIME_BALL.get()), "§bPear", ListUtil.createList("",
                "§8Left-click to select", "§8Right-click for more information"));
        ItemStack cattleItem = Item.create(Objects.requireNonNull(XMaterial.SPRUCE_FENCE.get()), "§bWheat",
                ListUtil.createList("", "§8Left-click to select", "§8Right-click for more information"));
        ItemStack meadowItem = Item.create(Objects.requireNonNull(XMaterial.SHORT_GRASS.get()), "§bMeadow",
                ListUtil.createList("", "§8Left-click to select", "§8Right-click for more information"));
        ItemStack harvestedItem = Item.create(Objects.requireNonNull(XMaterial.HAY_BLOCK.get()), "§bHarvested",
                ListUtil.createList("", "§8Left-click to select", "§8Right-click for more information"));
        ItemStack otherItem = Item.create(Objects.requireNonNull(XMaterial.DEAD_BUSH.get()), "§bOther", ListUtil.createList("",
                "§8Left-click to select", "§8Right-click for more information"));
