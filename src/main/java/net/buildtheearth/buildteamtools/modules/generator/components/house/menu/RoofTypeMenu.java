...
public class RoofTypeMenu extends AbstractMenu {
    ...
    protected void setPreviewItems() {
        ...
        ItemStack flatRoofItem = Item.create(Objects.requireNonNull(XMaterial.WHITE_CARPET.get()), "§bFlat Roof",
                ListUtil.createList("", "§eDescription:", "A flat roof for", "skyscrapers using carpets", "or slabs"));
        ItemStack gableRoofItem = Item.create(Objects.requireNonNull(XMaterial.COBBLESTONE_STAIRS.get()), "§bGable Roof",
                ListUtil.createList("", "§eDescription:", "A gable roof for", "residential houses using stairs"));
        ItemStack steepSlabRoofItem = Item.create(Objects.requireNonNull(XMaterial.COBBLESTONE_SLAB.get()), "§bSteep Slab Roof"
                , ListUtil.createList("", "§eDescription:", "A gable roof for", "residential houses using the", "steepest way " +
                        "you can", "create a roof with slabs"));
        ItemStack mediumSlabRoofItem = Item.create(Objects.requireNonNull(XMaterial.COBBLESTONE_SLAB.get()), "§bMedium Steep " +
                "Slab Roof", ListUtil.createList("", "§eDescription:", "A gable roof for", "residential houses by creating", "a" +
                " medium steep roof with slabs"));
        ItemStack flatterSlabRoofItem = Item.create(Objects.requireNonNull(XMaterial.COBBLESTONE_SLAB.get()), "§bFlatter Slab " +
                "Roof", ListUtil.createList("", "§eDescription:", "A flat gable roof for", "residential houses by creating", "a" +
                " very flat roof with slabs"));
