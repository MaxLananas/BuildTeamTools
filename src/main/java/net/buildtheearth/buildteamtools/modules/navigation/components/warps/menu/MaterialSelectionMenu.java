...
public class MaterialSelectionMenu extends AbstractMenu {
    ...
    protected void setMenuItemsAsync() {
        getMenu().getSlot(MATERIAL_SLOT).setItem(Item.create(Objects.requireNonNull(XMaterial.STONE.get()), "§6§lItem",
                ListUtil.createList("", "Change the material of the warp", "to a minecraft item.", "", "§eExample:", "Stone")));
