...
public class AddressTypeSelectionMenu extends AbstractMenu {
    ...
    protected void setMenuItemsAsync() {
        ...
        getMenu().getSlot(CUSTOM_SLOT).setItem(Item.create(Objects.requireNonNull(XMaterial.NAME_TAG.get()), "§6§lCustom " +
                "Address", ListUtil.createList("", "§7If no other address type fits,", "§7enter a custom address.")));
