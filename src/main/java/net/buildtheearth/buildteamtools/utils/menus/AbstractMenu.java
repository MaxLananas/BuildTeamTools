...
public abstract class AbstractMenu {
     ...
     * @param valueType      Type of the value (e.g. "m", "°C", "°F", "blocks", "chunks", "seconds", "minutes", "hours",
     *                       "days", "weeks", "months", "years", ...)
     */
    protected void createCounter(HeadColor sliderColor, int sliderItemSlot, String sliderName, int value, int minValue,
                                 int maxValue, String valueType) {
    ...
    protected void setChoiceItems(HeadColor sliderColor, int sliderItemSlot, String sliderName, ItemStack current) {
        ...
        if (current == null) {
            ...
            // Set current page item
            getMenu().getSlot(sliderItemSlot).setItem(Item.create(Objects.requireNonNull(XMaterial.BARRIER.get()),
                    sliderName + ": §c§lOFF"));
